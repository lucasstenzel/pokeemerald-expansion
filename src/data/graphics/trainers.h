...
const u32 gTrainerFrontPic_ChampionSteven[] = INCBIN_U32("graphics/trainers/front_pics/steven.4bpp.lz");
const u32 gTrainerPalette_ChampionSteven[] = INCBIN_U32("graphics/trainers/front_pics/steven.gbapal.lz");

const u32 gTrainerFrontPic_StevenAndWallace[] = INCBIN_U32("graphics/trainers/front_pics/stevenandwallace.4bpp.lz");
const u32 gTrainerPalette_StevenAndWallace[] = INCBIN_U32("graphics/trainers/front_pics/stevenandwallace.gbapal.lz");
...
const u32 gTrainerFrontPic_BeautyFirered[] = INCBIN_U32("graphics/trainers/front_pics/beauty_firered.4bpp.lz");
const u32 gTrainerPalette_BeautyFirered[] = INCBIN_U32("graphics/trainers/front_pics/beauty_firered.gbapal.lz");

const u32 gTrainerFrontPic_SuperNerdFirered[] = INCBIN_U32("graphics/trainers/front_pics/super_nerd_firered.4bpp.lz");
const u32 gTrainerPalette_SuperNerdFirered[] = INCBIN_U32("graphics/trainers/front_pics/super_nerd_firered.gbapal.lz");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_ROARK, gTrainerFrontPic_Roark, gTrainerPalette_Roark),
    TRAINER_SPRITE(TRAINER_PIC_DAWN, gTrainerFrontPic_Dawn, gTrainerPalette_Dawn),
    TRAINER_SPRITE(TRAINER_PIC_GARDENIA, gTrainerFrontPic_Gardenia, gTrainerPalette_Gardenia),
    TRAINER_SPRITE(TRAINER_PIC_MAYLENE, gTrainerFrontPic_Maylene, gTrainerPalette_Maylene),
    TRAINER_SPRITE(TRAINER_PIC_WAKE, gTrainerFrontPic_Wake, gTrainerPalette_Wake),
    TRAINER_SPRITE(TRAINER_PIC_FANTINA, gTrainerFrontPic_Fantina, gTrainerPalette_Fantina),
    TRAINER_SPRITE(TRAINER_PIC_BYRON, gTrainerFrontPic_Byron, gTrainerPalette_Byron),
    TRAINER_SPRITE(TRAINER_PIC_CANDICE, gTrainerFrontPic_Candice, gTrainerPalette_Candice),
    TRAINER_SPRITE(TRAINER_PIC_VOLKNER, gTrainerFrontPic_Volkner, gTrainerPalette_Volkner),
    TRAINER_SPRITE(TRAINER_PIC_CYNTHIA, gTrainerFrontPic_Cynthia, gTrainerPalette_Cynthia),
    TRAINER_SPRITE(TRAINER_PIC_TATE, gTrainerFrontPic_Tate, gTrainerPalette_Tate),
    TRAINER_SPRITE(TRAINER_PIC_LIZA, gTrainerFrontPic_Liza, gTrainerPalette_Liza),
    TRAINER_SPRITE(TRAINER_PIC_CHAMPION_STEVEN, gTrainerFrontPic_ChampionSteven, gTrainerPalette_ChampionSteven, 0, 7, 0x188),
    TRAINER_SPRITE(TRAINER_PIC_STEVENANDWALLACE, gTrainerFrontPic_StevenAndWallace, gTrainerPalette_StevenAndWallace),
